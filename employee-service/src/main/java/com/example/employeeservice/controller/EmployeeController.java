...
//        Map<String, Object> department = departmentClient.getDepartmentById(1L);
...
//    }
    ...
    @GetMapping("/{id}")
    public CompletableFuture<Map<String, Object>> getEmployeeWithDepartment(@PathVariable Long id)
    {
